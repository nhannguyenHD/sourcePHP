        ...
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                <p>
                    ...
                    made <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="index.php?page=about"
                        target="_blank">Nguyễn ND Nhân </a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
...
<!-- Classy Nav js -->
<script src="../public/js/classy-nav.min.js"></script>
<!-- Active js -->
