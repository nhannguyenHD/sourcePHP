        ...
        <div class="row">
            ...
            <!-- Slide-show -->
                ...
                <?php 
                    ...
                    $link="?page=product&idproduct=".$curr_product['id_product']; 
                    ...
                    <div class="single-product-wrapper">
                        ...
                        <div class="product-img">
                            ...
                            <!-- Hover Thumb -->
                            <a href="<?=$link?>"><img class="hover-img" src="<?=$img1['name_product']?>" alt=""></a>
                        ...
                        <div class="product-description">
                            <span><?=$curr_product['name_type']?> &#45;&#45; <?=$curr_product['name_brand']?></span>
                            <a href="<?=$link?>">
...
<div class="brands-area d-flex align-items-center justify-content-between">
    ...
    <div class="single-brands-logo">
        <img src="<?=$img_path.$brands['image']?>" alt="">
    </div>
     <?php } ?>
