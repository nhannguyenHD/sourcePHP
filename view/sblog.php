...
<div class="single-blog-wrapper">
    ...
    <div class="single-blog-post-thumb">
        <img src="../public/img/bg-img/bg-7.jpg" alt="">
    </div>
    ...
    <div class="single-blog-content-wrapper d-flex">
        ...
        <div class="single-blog--text">
            <h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corporis perferendis rem accusantium ducimus
                animi nesciunt expedita omnis aut quas molestias!</h2>
            ...
            <blockquote>
                <h6><i class="fa fa-quote-left" aria-hidden="true"></i> Quisque sagittis non ex eget vestibulum. Sed nec
                    ultrices dui. Cras et sagittis erat. Maecenas pulvinar, turpis in dictum tincidunt, dolor nibh
                    lacinia lacus.</h6>
        ...
        <div class="related-blog-post">
            ...
            <div class="single-related-blog-post">
                <img src="../public/img/bg-img/rp1.jpg" alt="">
                <a href="#">
            ...
            <!-- Single Related Blog Post -->
            <div class="single-related-blog-post">
                <img src="../public/img/bg-img/rp2.jpg" alt="">
                <a href="#">
            ...
            <!-- Single Related Blog Post -->
            <div class="single-related-blog-post">
                <img src="../public/img/bg-img/rp3.jpg" alt="">
                <a href="#">
            ...
            <!-- Single Related Blog Post -->
            <div class="single-related-blog-post">
                <img src="../public/img/bg-img/rp4.jpg" alt="">
                <a href="#">
